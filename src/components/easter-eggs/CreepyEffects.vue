...
function corruptRandomText() {
  ...
  const creepyReplacements = [
    '他們來了', '快跑', '不要看', '...', '你聽到了嗎', '就在你身後',
    '█████', '??????????', 'たすけて', '見ないで', '逃げて',
    'HELP ME', 'THEY ARE HERE', 'DON\'T TRUST IT',
    '도와줘', '살려줘', 'Помогите',
    '你聽到敲門聲了嗎', '窗外有東西', '不要開門',
    '第四面牆已經碎了', '你不是在看網頁 網頁在看你',
    '삭제됨', '데이터 손상', 'CORRUPTED',
    'ẗ̸̢h̵̰̊ë̶̞y̸̖̌ ̴̣̈a̵͖̐r̶̰̈́ë̶̤ ̶̣̌h̶̰̊ë̵̤r̸̰̈́ë̵̤',
  ]
...
const messages = [
  ...
  '醒來', '這不是夢', '他們就在門外', '你確定你是一個人嗎',
  '信號已被攔截', '不要相信你看到的', '你的位置已被標記',
  '為什麼你還在這裡', '離開', '太遲了',
  'たすけて', '見ないで', '逃げられない', 'ここにいるよ',
  '誰かが見ている', '後ろを見るな', '聞こえますか',
  'THEY KNOW', 'DO NOT LOOK BEHIND YOU', 'WE SEE YOU',
  'IT IS TOO LATE', 'YOU WERE WARNED', 'SIGNAL INTERCEPTED',
  'Мы наблюдаем', 'Не оглядывайся',
  '도망칠 수 없어', '우리는 여기 있어',
  '01001000 01000101 01001100 01010000',
  '你的攝影機已開啟', '第三隻眼已經睜開',
  '這個網頁不存在', '你不在這裡', '你確定螢幕後面沒有人嗎',
  '我數到三 不要動', '你聽到那個聲音了嗎',
]
